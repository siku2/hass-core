...
ThermostatModeEnum = Literal["off", "heating", "cooling"]
ThermostatStateEnum = Literal["off", "heating", "cooling"]
...
class OutputConfig(TypedDict, total=False):
    active: bool
    name: str
    type: Literal["light", "fan", "power_socket"] | str
    groups: str
...
class Client:
    ...
    async def set_dimmer(
        self,
        index: int,
        action: Literal["on", "off", "toggle", "dim", "pulse"],
        *,
        value: int | None = None,
        ramp: int | None = None,
    ...
    async def move_blind(
        ...
        index: int,
        action: Literal[
            "stop", "up", "down", "initialize", "upstop", "downstop", "togglestop"
        ],
        *,
        time: int | None = None,
    ) -> None:
